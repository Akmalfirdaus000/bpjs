    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-neutral-200 dark:border-emerald-800/40 bg-gradient-to-r from-neutral-50 via-emerald-50 to-neutral-50 dark:from-neutral-950 dark:via-emerald-950 dark:to-neutral-950 p-6 md:p-8 shadow-sm dark:shadow-2xl">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {/* Stat Card 1 */}
                    <Card className="relative overflow-hidden border border-border dark:border-emerald-900 bg-card dark:bg-emerald-950/20 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                        <CardContent className="p-5">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Total PNS Aktif</span>
                                <div className="p-2 bg-neutral-100 dark:bg-emerald-950/40 border border-neutral-200 dark:border-emerald-800/30 rounded-lg">
                                    <Users className="size-4 text-neutral-600 dark:text-emerald-700" />
                                </div>
                            </div>
                            <div className="mt-4 flex items-baseline gap-2">
                                <span className="text-3xl font-black text-neutral-900 dark:text-white">{stats.totalPegawai}</span>
                                <span className="text-xs text-neutral-500">PNS terdaftar</span>
                            </div>
                            <div className="absolute bottom-0 left-0 right-0 h-1 bg-primary dark:bg-emerald-800" />
                        </CardContent>
                    </Card>
                    ...
                    <Card className="relative overflow-hidden border border-border dark:border-emerald-900 bg-card dark:bg-emerald-950/20 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                        <CardContent className="p-5">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="p-2 bg-neutral-100 dark:bg-emerald-950/40 border border-neutral-200 dark:border-emerald-800/30 rounded-lg">
                                    <FileSpreadsheet className="size-4 text-neutral-600 dark:text-emerald-700" />
                                </div>
                            </div>
                            <div className="mt-4 flex items-baseline gap-2">
                                <span className="text-3xl font-black text-neutral-900 dark:text-white">{stats.totalPengajuan}</span>
                    ...
                    <Card className="relative overflow-hidden border border-border dark:border-emerald-900 bg-card dark:bg-emerald-950/20 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                        <CardContent className="p-5">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Dalam Proses BPJS</span>
                    ...
                    <Card className="relative overflow-hidden border border-border dark:border-emerald-900 bg-card dark:bg-emerald-950/20 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
                        <CardContent className="p-5">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="p-2 bg-green-50 dark:bg-emerald-950/40 border border-green-200 dark:border-emerald-800/30 rounded-lg">
                                    <CheckCircle className="size-4 text-green-600 dark:text-emerald-700" />
                                </div>
                            </div>
                            <div className="mt-4 flex items-baseline gap-2">
                                <span className="text-3xl font-black text-green-600 dark:text-emerald-700">{stats.selesai}</span>
                                <span className="text-xs text-neutral-500">Mutasi disahkan</span>
                            </div>
                            <div className="absolute bottom-0 left-0 right-0 h-1 bg-green-500 dark:bg-emerald-800" />
                        </CardContent>
                    </Card>
                </div>                {/* Graphics & Info Section */}
                <div className="grid gap-6 md:grid-cols-3">
                    {/* Left Column: Visual Status Bar Chart */}
                    <Card className="border border-border dark:border-neutral-800 bg-card dark:bg-neutral-900 shadow-sm">
                        <CardHeader className="p-4 border-b border-border dark:border-neutral-800 flex flex-row items-center justify-between">
                            <CardTitle className="text-sm font-bold flex items-center gap-2 text-neutral-900 dark:text-emerald-700">
                                <BarChart3 className="size-4 text-neutral-600 dark:text-emerald-700" />
                                Beban Status Pengajuan
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="p-6 flex flex-col items-center justify-center">
                            <div className="w-full flex items-end justify-around h-[160px] border-b border-border dark:border-neutral-800 pb-2">
                                {/* Bar Pending */}
                    ...
                    <Card className="border border-border dark:border-neutral-800 bg-card dark:bg-neutral-900 shadow-sm">
                        <CardHeader className="p-4 border-b border-border dark:border-neutral-800">
                            <CardTitle className="text-sm font-bold flex items-center gap-2 text-neutral-900 dark:text-emerald-700">
                            ...
                            <div className="space-y-3">
                                {topSatker.length === 0 ? (
                                    ...
                                    topSatker.map((satker, idx) => (
                                        <div key={idx} className="flex items-center justify-between p-2.5 rounded-lg bg-neutral-50 dark:bg-neutral-950 border border-border dark:border-neutral-800">
                                            <div className="flex items-center gap-2 min-w-0">
                                                <div className="flex items-center justify-center size-6 rounded bg-green-50 dark:bg-emerald-950 text-green-600 dark:text-emerald-700 text-xs font-black shrink-0">
                                                    {idx + 1}
                                                </div>
                                                <span className="text-xs text-neutral-700 dark:text-neutral-300 font-medium truncate">{satker.satuan_kerja}</span>
                                            </div>
                                            <span className="text-xs font-bold text-green-600 dark:text-emerald-700 shrink-0 ml-2">{satker.total} Berkas</span>
                                        </div>
                                    ))
                                )}
                            </div>
                ...
                <Card className="border border-border dark:border-neutral-800 bg-card dark:bg-neutral-900 shadow-sm">
                    <CardHeader className="border-b border-border dark:border-neutral-800 p-4">
                        <CardTitle className="text-sm font-bold flex items-center gap-2 text-neutral-900 dark:text-emerald-700">
                        ...
                        {recentPensions.length === 0 ? (
                            ...
                            <div className="divide-y divide-border dark:divide-neutral-800">
                                {recentPensions.map((pensiunan) => (
                                    <div key={pensiunan.id} className="p-4 hover:bg-neutral-50 dark:hover:bg-neutral-950 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-2 flex-wrap">
                                                <span className="font-semibold text-sm text-neutral-900 dark:text-emerald-700">
                                            ...
                                            <div className="text-xs text-neutral-500 dark:text-neutral-400 flex items-center gap-1.5 flex-wrap">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    <Calendar className="size-3 text-neutral-400 dark:text-neutral-500" />
                                                    <span>TMT Pensiun: <span className="font-medium text-neutral-700 dark:text-neutral-300">{new Date(pensiunan.tanggal_pensiun).toLocaleDateString('id-ID')}</span></span>
                                                </div>
                                            </div>
                                        </div>
